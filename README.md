...
Additional operational phases are available for secrets, backup, lab evidence capture, upgrade planning, guarded destroy planning, and CI smoke checks. See `docs/operations.md`.
