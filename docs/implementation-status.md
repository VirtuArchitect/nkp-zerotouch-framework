...
| Live demo | Implemented | GitHub Pages prototype under `docs/demo/`, including console evidence-pack review, published to `gh-pages` by `.github/workflows/pages.yml` |
